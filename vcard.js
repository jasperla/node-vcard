...
var vCard = /** @class */ (function () {
    ...
    /*
       ...
       */
    vCard.prototype.readFile = function (file, cb) {
     ...
     */
    vCard.prototype.readData = function (card, cb) {
    ...
    ;
    vCard.prototype.putValueInObject = function (json, key, value, fields) {
        if (json[key]) {
            if (value.type && value.type.length > 0) {
                var found = value.type.find(function (t) { return t.indexOf('=') !== -1; }) || value.type[0];
                var newKey = key + '-' + found.replace(/TYPE=/g, '');
                if (!json[newKey]) {
                    json[newKey] = value;
                    return;
                }
    ...
    /*
       ...
       */
    vCard.prototype.parsevCard = function (data, cb) {
        var inserted = 0;
        var json = {};
    ...
    /*
       ...
       */
    vCard.prototype.getValidationError = function (data) {
    ...
    vCard.prototype.getVersion = function (data) {
        var version;
